...
\score {
	\new StaffGroup <<
		\new Staff \compressMMRests \keepWithTag #'Part { \markLengthOn \Violin_II_mvmt_II }
		\new Staff \with { \RemoveAllEmptyStaves } \compressMMRests \keepWithTag #'Part \Violin_II_divisi_II_mvmt_II
	>>
	\layout {
	\context {
		\Score
...
\score {
	\new StaffGroup <<
		\new Staff \compressMMRests \keepWithTag #'Part { \markLengthOn \Violin_II_mvmt_III }
		\new Staff \with { \RemoveAllEmptyStaves } \compressMMRests \keepWithTag #'Part \Violin_II_divisi_II_mvmt_III
	>>
	\layout {
	\context {
		\Score
