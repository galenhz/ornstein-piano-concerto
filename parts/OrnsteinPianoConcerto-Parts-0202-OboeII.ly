...
\score {
	\new Staff \compressMMRests  \keepWithTag #'Part { \markLengthOn \Oboe_II_mvmt_I }
	\layout {
	\context {
		\Score
...
\score {
	\new Staff \compressMMRests  \keepWithTag #'Part { \markLengthOn \Oboe_II_mvmt_II }
	\layout {
	\context {
		\Score
			rehearsalMarkFormatter = #format-mark-circle-numbers
...
\score {
	\new Staff \compressMMRests  \keepWithTag #'Part { \markLengthOn \Oboe_II_mvmt_III }
	\layout {
	\context {
		\Score
			rehearsalMarkFormatter = #format-mark-circle-numbers
