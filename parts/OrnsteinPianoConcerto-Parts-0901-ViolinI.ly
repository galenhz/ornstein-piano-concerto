...
\score {
	\new StaffGroup <<
		\new Staff \compressMMRests \keepWithTag #'Part { \markLengthOn \Violin_I_mvmt_II }
		\new Staff \with { \RemoveAllEmptyStaves } \compressMMRests \keepWithTag #'Part \Violin_I_divisi_II_mvmt_II
	>>
	\layout {
	\context {
		\Score
