...
\score {
	\new Staff \compressMMRests  \keepWithTag #'Part { \markLengthOn \Trombone_III_mvmt_II }
	\layout {
	\context {
		\Score
			rehearsalMarkFormatter = #format-mark-circle-numbers
...
\score {
	\new Staff \compressMMRests  \keepWithTag #'Part { \markLengthOn \Trombone_III_mvmt_III }
	\layout {
	\context {
		\Score
			rehearsalMarkFormatter = #format-mark-circle-numbers
