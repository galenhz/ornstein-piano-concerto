...
\score {
	\new Staff \compressMMRests  \keepWithTag #'Part { \markLengthOn \Trumpet_I_mvmt_I }
	\layout {
	\context {
		\Score
...
\score {
	\new Staff \compressMMRests  \keepWithTag #'Part { \markLengthOn \Trumpet_I_mvmt_II }
	\layout {
	\context {
		\Score
			rehearsalMarkFormatter = #format-mark-circle-numbers
...
\score {
	\new Staff \compressMMRests  \keepWithTag #'Part { \markLengthOn \Trumpet_I_mvmt_III }
	\layout {
	\context {
		\Score
			rehearsalMarkFormatter = #format-mark-circle-numbers
