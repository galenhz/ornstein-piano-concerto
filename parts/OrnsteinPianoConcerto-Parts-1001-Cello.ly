...
\score {
	\new StaffGroup <<
		\new Staff \compressMMRests \keepWithTag #'Part { \markLengthOn \Cello_mvmt_II }
		\new Staff \with { \RemoveAllEmptyStaves } \compressMMRests \keepWithTag #'Part \Cello_divisi_II_mvmt_II
	>>
	\layout {
	\context {
		\Score
