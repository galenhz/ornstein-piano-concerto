...
\score {
	\new Staff \compressMMRests  \keepWithTag #'Part { \markLengthOn \Bassoon_III_mvmt_I }
	\layout {
	\context {
		\Score
...
\score {
	\new Staff \compressMMRests  \keepWithTag #'Part { \markLengthOn \Bassoon_III_mvmt_II }
	\layout {
	\context {
		\Score
			rehearsalMarkFormatter = #format-mark-circle-numbers
...
\score {
	\new Staff \compressMMRests  \keepWithTag #'Part { \markLengthOn \Bassoon_III_mvmt_III }
	\layout {
	\context {
		\Score
			rehearsalMarkFormatter = #format-mark-circle-numbers
