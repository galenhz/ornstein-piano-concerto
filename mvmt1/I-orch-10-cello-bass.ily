...
Cello_mvmt_I_BR = \relative c, {
	\tempo "Calmato"
	\time 4/4
	\tag #'Score \grace s8
	\tuplet 7/4 { fis4 cis' a' cis, a ees r4 }
	\tuplet 7/4 { fis4 cis' a' cis, a ees r4 }
	\time 3/4
	fis2.~\pp
	fis2.
...
Bass_mvmt_I_BR = \relative c {
	...
	<<
		\new Voice {
			\voiceOne
			\tuplet 7/4 { fis1.:32 a4:32 }
			\tuplet 7/4 { fis1.:32 a4:32 }
		}
		\new Voice {
			\voiceTwo
			\tuplet 7/4 { fis,1.:32\mp a4:32 }
			\tuplet 7/4 { fis1.:32 a4:32 }
		}
	>>
	\time 3/4
...
Cello_mvmt_I = { \clef bass \NULL_I_AA \Cello_mvmt_I_AB \NULL_I_AC \Cello_mvmt_I_AD \Cello_mvmt_I_AE \Cello_mvmt_I_AF \Cello_mvmt_I_AG \Cello_mvmt_I_AH
		...
		\Cello_mvmt_I_BM \NULL_I_BN \Cello_mvmt_I_BO \Cello_mvmt_I_BP \Cello_mvmt_I_BQ \Cello_mvmt_I_BR }
...
Bass_mvmt_I = { \clef bass \NULL_I_AA \Bass_mvmt_I_AB \NULL_I_AC \Bass_mvmt_I_AD \Bass_mvmt_I_AE \Bass_mvmt_I_AF \Bass_mvmt_I_AG \Bass_mvmt_I_AH
		...
		\Bass_mvmt_I_BP \Bass_mvmt_I_BQ \Bass_mvmt_I_BR }
