...
Viola_divisi_II_mvmt_I_BD = \relative c' {
	...
	>>
	\bar "||" % Divisi part gets no fermata
}
...
Violin_I_divisi_II_mvmt_I_BQ = \relative c' {
	\mark #37
	\tempo "Mosso"
	\time 2/4
	f?4:32\mf f4:32
...
Violin_II_mvmt_I_BQ = \relative c' {
	\mark #37
	\tempo "Mosso"
	\time 2/4
	cis4:32\mf cis4:32
...
Violin_I_mvmt_I_BR = \relative c'' {
	...
	<<
		\new Voice {
			\voiceOne
			b2\rest b8\rest^\Div_mark \ottava #1 a''8~
			a2. \ottava #0
		}
		\new Voice {
			\voiceTwo
...
Violin_I_divisi_II_mvmt_I_BR = \relative c'' {
	\tempo "Calmato"
	\time 4/4
	\tag #'Score \grace s8
	R1*2
	...
	<<
		\new Voice {
			\voiceOne
			b2\rest b8\rest^\Div_mark cis'8~
			cis2.
		}
		\new Voice {
			\voiceTwo
...
Violin_II_mvmt_I_BR = \relative c' {
	\tempo "Calmato"
	\time 4/4
	\tag #'Score \grace s8
	<<
		\new Voice {
			...
			fis1:32
			\time 3/4
			\tuplet 3/2 { fis8[ fis fis] } fis~ fis4 fis8~
			fis2.
		}
		\new Voice {
			\voiceTwo
			...
			cis1:32
			\time 3/4
			\tuplet 3/2 { cis8[\pp cis cis] } cis~ cis4 cis8~
			cis2.
		}
	>>
	\bar "|."
...
Violin_II_divisi_II_mvmt_I_BR = \relative c' {
	\tempo "Calmato"
	\time 4/4
	\tag #'Score \grace s8
	a1:32^\DivIII_mark\mp
	a1:32
	\time 3/4
	\tuplet 3/2 { a8[\pp a a] } a~ a4 a8~
	a2.
	\bar "|."
}

Viola_mvmt_I_BR = \relative c' {
	\tempo "Calmato"
	\time 4/4
	\tag #'Score \grace s8
	<<
		\new Voice {
			...
			bis1:32
			\time 3/4
			\tuplet 3/2 { bis8[ bis bis] } bis~ bis4 bis8~
			bis2.
		}
		\new Voice {
			\voiceTwo
			...
			fis1:32
			\time 3/4
			\tuplet 3/2 { fis8[\pp fis fis] } fis~ fis4 fis8~
			fis2.
		}
	>>
	\bar "|."
...
Viola_divisi_II_mvmt_I_BR = \relative c {
	\tempo "Calmato"
	\time 4/4
	\tag #'Score \grace s8
	cis1:32^\DivIII_mark\mp
	cis1:32
	\time 3/4
	\tuplet 3/2 { cis8[\pp cis cis] } cis~ cis4 cis8~
	cis2.
...
Violin_I_mvmt_I = { \NULL_I_AA \Violin_I_mvmt_I_AB \NULL_I_AC \Violin_I_II_mvmt_I_AD \Violin_I_mvmt_I_AE \Violin_I_mvmt_I_AF \Violin_I_mvmt_I_AG
		...
		\Violin_I_mvmt_I_BQ \Violin_I_mvmt_I_BR }
Violin_I_divisi_II_mvmt_I = { \NULL_I_AA \Violin_I_divisi_II_mvmt_I_AB \NULL_I_AC \NULL_I_AD \NULL_I_AE \NULL_I_AF \NULL_I_AG \NULL_I_AH \NULL_I_AI
		...
		\NULL_I_AU \NULL_I_AV \NULL_I_AW \NULL_I_AX \NULL_I_AY \NULL_I_AZ \NULL_I_BA \NULL_I_BB \NULL_I_BC \NULL_I_BD_nofermata \NULL_I_BE \NULL_I_BF
		\Violin_I_divisi_II_mvmt_I_BG \NULL_I_BH \NULL_I_BI \NULL_I_BJ \Violin_I_divisi_II_mvmt_I_BK \Violin_I_divisi_II_mvmt_I_BL
		\Violin_I_divisi_II_mvmt_I_BM \NULL_I_BN \NULL_I_BO \NULL_I_BP \Violin_I_divisi_II_mvmt_I_BQ \Violin_I_divisi_II_mvmt_I_BR }
...
Violin_II_mvmt_I = { \NULL_I_AA \Violin_II_mvmt_I_AB \NULL_I_AC \Violin_I_II_mvmt_I_AD \Violin_II_mvmt_I_AE \Violin_II_mvmt_I_AF \Violin_II_mvmt_I_AG
		...
		\Violin_II_mvmt_I_BQ \Violin_II_mvmt_I_BR }
Violin_II_divisi_II_mvmt_I = { \NULL_I_AA \Violin_II_divisi_II_mvmt_I_AB \NULL_I_AC \NULL_I_AD \Violin_II_divisi_II_mvmt_I_AE
		...
		\NULL_I_BC \NULL_I_BD_nofermata \NULL_I_BE \NULL_I_BF \Violin_II_divisi_II_mvmt_I_BG \Violin_II_divisi_II_mvmt_I_BH \NULL_I_BI \NULL_I_BJ
		\NULL_I_BK \NULL_I_BL \Violin_II_divisi_II_mvmt_I_BM \NULL_I_BN \NULL_I_BO \NULL_I_BP \NULL_I_BQ \Violin_II_divisi_II_mvmt_I_BR }
...
Viola_mvmt_I = { \clef alto \NULL_I_AA \Viola_mvmt_I_AB \NULL_I_AC \Viola_mvmt_I_AD \Viola_mvmt_I_AE \Viola_mvmt_I_AF \Viola_mvmt_I_AG \Viola_mvmt_I_AH
		...
		\Viola_mvmt_I_BP \Viola_mvmt_I_BQ \Viola_mvmt_I_BR }
Viola_divisi_II_mvmt_I = { \clef alto \NULL_I_AA \NULL_I_AB \NULL_I_AC \NULL_I_AD \NULL_I_AE \NULL_I_AF \NULL_I_AG \NULL_I_AH \NULL_I_AI
		...
		\Viola_divisi_II_mvmt_I_BM \NULL_I_BN \NULL_I_BO \NULL_I_BP \NULL_I_BQ \Viola_divisi_II_mvmt_I_BR }
