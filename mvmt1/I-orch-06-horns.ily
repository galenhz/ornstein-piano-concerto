...
% Cues only. (Don't need them for VII, as it's out until mvmt 3.)
Horn_V_VI_mvmt_I_BA = \transpose c' f \relative c' {
	\tag #'Score \NULL_I_BA
	\tag #'Part {
		\mark #19
		\time 6/8
...
Horn_melody_mvmt_I_BK_partial = \transpose c' f \relative c'' {
	\mark #30
	\time 6/8
	\override Staff.Beam.breakable = ##t
	r8_\markup { \dynamic fff \italic "molto marcato" } bes[ cis d e8.-^ e16]
	\time 4/8
	g8-^[ f16( \beamCutR e) \beamCutL f( e) d8-^
	\time 6/8
	e16( \beamCutR d) \beamCutL cis-^( \beamCutR bes) \beamCutL cis( d) e8-^ g-^ f16( e)
	\time 4/8
	d8-^] r8 bes[ cis
	\time 6/8
	d e8.-^ e16] g8-^[ f16( \beamCutR e) \beamCutL f( e)
	\time 4/8
	d8-^ e16( \beamCutR d) \beamCutL cis-^( \beamCutR bes) \beamCutL cis( d)
	\time 6/8
	e8-^ g-^ f16( e) d8-^]
}

Horn_conclusion_mvmt_I_BK_partial = \transpose c' f \relative c'' {
		r8 cis[
	\time 4/8
	e f e16( d) cis8]
	\time 6/8
	r8 cis[ e d16( \beamCutR cis) \beamCutL d( cis) bes8]
	\revert Staff.Beam.breakable
}

Horn_I_mvmt_I_BK = { \Horn_melody_mvmt_I_BK_partial \Horn_conclusion_mvmt_I_BK_partial }

Horn_II_mvmt_I_BK = { \transpose c' c \Horn_melody_mvmt_I_BK_partial \Horn_conclusion_mvmt_I_BK_partial }

Horn_III_mvmt_I_BK = { \Horn_melody_mvmt_I_BK_partial \transpose c' c \Horn_conclusion_mvmt_I_BK_partial }

Horn_IV_mvmt_I_BK = { \transpose c' c \Horn_melody_mvmt_I_BK_partial \transpose c' f \relative c'' {
		r8 bes8~
	\time 4/8
	bes bes[ bes bes]
	\time 6/8
...
Horn_V_mvmt_I_BK = \transpose c' f \relative c'' {
	\mark #30
	\time 6/8
	r8 bes4\f bes bes8
	\time 4/8
...
Horn_VI_mvmt_I_BK = \transpose c' f \relative c' {
	\mark #30
	\time 6/8
	r8 d4\f d d8
	\time 4/8
...
Horn_I_mvmt_I_BL = \transpose c' f \relative c'' {
	\mark #31
	\tempo "Doppio Lento"
	\time 4/4
	r4 bes8(\f gis) a4 a
...
Horn_II_mvmt_I_BL = \transpose c' f \relative c'' {
	\mark #31
	\tempo "Doppio Lento"
	\time 4/4
	R1*3
	\tuplet 3/2 { r8 gis4~ } gis2.
	\mark #32
	\time 2/4
	\repeat unfold 2 {
		r8 b4.
...
Horn_III_mvmt_I_BL = \transpose c' f \relative c' {
	\mark #31
	\tempo "Doppio Lento"
	\time 4/4
	\partCombineApart
	...
	r8 gis~ gis2.
	a2~ a4 d,
	\tuplet 3/2 { r8 bes'4~ } bes2.
	\mark #32
	\time 2/4
	%\partCombineApart
	\repeat unfold 4 { r8 gis4. }
	\time 3/4
	r8 g~ g2
	r8 g~ g2
	\partCombineAutomatic
...
Horn_IV_mvmt_I_BL = \transpose c' f \relative c' {
	\mark #31
	\tempo "Doppio Lento"
	\time 4/4
	r4 cis4\f r2
...
Horn_I_mvmt_I_BM = \transpose c' f \relative c'' {
	\mark #33
	\time 4/8
	\tag #'Score \grace s8
	R2*3
	\tempo "Stringendo sempre e cresc."
	r4 r8 \tuplet 3/2 { r16\mf gis a }
	\tuplet 3/2 8 {
		b-^[ c r32 dis] dis8[ dis16] e-^[ dis cis] dis-^[ cis c]
		b-^[ c r32 dis] dis16[ e f] gis-^[ g f] g-^[ f e]
		\tempo "Stretto"
		\partCombineApart
		\repeat unfold 2 { r16 gis,[ a] c8-^[ b16] r16 gis[ a] dis-^[ c b] }
		\partCombineAutomatic
		\tempo "Molto Agitato"
		\repeat unfold 2 { r16 gis[ a] gis'-^[ f e] }
		\tag #'Score r16 \tag #'Part r16_\markup \italic "rit." gis,[ a] gis'-^[ f e] gis-^[ f e] gis-^[ f-^ e-^]
	}
}

Horn_II_mvmt_I_BM = \transpose c' f \relative c'' {
	\mark #33
	\time 4/8
	\tag #'Score \grace s8
	R2*3
	...
	\tuplet 3/2 8 {
		...
		b-^[ c r32 dis] dis16[ e f] gis-^[ g f] g-^[ f e]
		\tempo "Stretto"
		\repeat unfold 2 { r16 a,[ a] a8-^[ a16] r16 gis[ gis] gis8-^[ gis16] }
		\tempo "Molto Agitato"
		\repeat unfold 2 { r16 a[ a] a8-^[ a16] }
	}
	r16_\markup \italic "rit." a~ a[ a]~ a[ a]~ a[ a]
}

Horn_III_mvmt_I_BM = \transpose c' f \relative c'' {
	\mark #33
	\time 4/8
	\tag #'Score \grace s8
	R2*3
	...
	R2
	\tuplet 3/2 8 {
		gis16\mf gis r16 gis8-^[ gis16] f f r16 f8-^[ f16]
		gis16 gis r16 gis8-^[ gis16] f f r16 f8-^[ f16]
		\tempo "Stretto"
		r16\f cis' cis cis8-^[ cis16] r16 gis' gis gis8-^[ gis16]
		r16 cis, cis cis8-^[ cis16] r16 gis' gis gis8-^[ gis16]
		\tempo "Molto Agitato"
		\repeat unfold 2 { r16 cis, cis cis8-^[ cis16] }
	}
	\tag #'Score r16 \tag #'Part r16_\markup \italic "rit." cis16~ cis[ cis]~ cis[ cis]~ cis[ cis]
}

Horn_IV_mvmt_I_BM = \transpose c' f \relative c'' {
	\mark #33
	\time 4/8
	\tag #'Score \grace s8
	R2*3
	...
	R2
	\tuplet 3/2 8 {
		c16\mf c r16 c8-^[ c16] cis cis r16 cis8-^[ cis16]
		c16 c r16 c8-^[ c16] cis cis r16 cis8-^[ cis16]
		\tempo "Stretto"
		\repeat unfold 2 { r16 gis[ a] c8-^[ b16] r16 gis[ a] dis-^[ c b] }
		\tempo "Molto Agitato"
		\repeat unfold 2 { r16 gis[ a] gis'-^[ f e] }
		r16_\markup \italic "rit." gis,[ a] gis'-^[ f e] gis-^[ f e] gis-^[ f-^ e-^]
	}
}

Horn_V_mvmt_I_BM = \transpose c' f \relative c' {
	\mark #33
	\time 4/8
	\tag #'Score \grace s8
	R2*3
	...
	R2
	\tuplet 3/2 8 {
		e16\mf e r16 e8[ e16] cis'16 cis r16 cis8-^ cis16
		e,16 e r16 e8[ e16] cis'16 cis r16 cis8-^ cis16
		\tempo "Stretto"
		\repeat unfold 2 { r16 f[ f] f8-^[ f16] r16 e[ e] e8-^[ e16] }
		\tempo "Molto Agitato"
		\repeat unfold 2 { r16 f[ f] f8-^[ f16] }
	}
	r16 f16~ f[ f]~ f[ f]~ f[ f]
}

Horn_VI_mvmt_I_BM = \transpose c' f \relative c' {
	\mark #33
	\time 4/8
	\tag #'Score \grace s8
	R2*3
	...
	R2
	\tuplet 3/2 8 {
		bes16\mf bes r16 bes8[ bes16] a'16 a r16 a8-^ a16
		bes,16 bes r16 bes8[ bes16] a'16 a r16 a8-^ a16
		\tempo "Stretto"
		\repeat unfold 2 { r16 f[ f] f8-^[ f16] r16 c'[ c] c8-^[ c16] }
		\tempo "Molto Agitato"
		\repeat unfold 2 { r16 f,[ f] f8-^[ f16] }
	}
	r16 f16~ f[ f]~ f[ f]~ f[ f]
...
Horn_I_mvmt_I_BO = \transpose c' f \relative c'' {
	\mark #35
	\time 10/8
	d8[(\mf e] e4 d) fis( e)
	\time 11/8
...
Horn_II_mvmt_I_BO = \transpose c' f \relative c' {
	\mark #35
	\time 10/8
	e8[(\mf fis] fis4 e) g( fis)
	\time 11/8
	e8[( fis] fis4 e) cis( fis e8)
	\time 10/8
	e8[( fis] fis4 e) g( fis)
	e( cis fis) b( fis)
	a,( c f) ees r
...
Horn_III_mvmt_I_BO = \transpose c' f \relative c'' {
	\mark #35
	\time 10/8
	a8[(\mf b] b4 a) cis( b)
	\time 11/8
...
Horn_IV_mvmt_I_BO = \transpose c' f \relative c' {
	\mark #35
	\time 10/8
	b8[(\mf cis] cis4 b) d( cis)
	\time 11/8
	b8[( cis] cis4 b) g( cis b8)
	\time 10/8
	b8[( cis] cis4 b) d( cis)
	b( a cis) d( cis)
	e( f, bes) r4 c4
...
Horn_V_VI_cues_mvmt_I_BO = \transpose c' f \relative c'' {
	\tag #'Score \NULL_I_BO
	\tag #'Part {
		\mark #35
		\time 10/8
		...
		<<
			\new CueVoice {
				\transpose f c' \relative c'' { r4 r4 aes4^"I Ob." des ees }
			}
			\new Voice {
				\voiceTwo
				R1*10/8
...
Horn_I_mvmt_I_BP = \transpose c' f \relative c'' {
	\mark #36
	\time 4/4
	fis8 r8 r4 r2
	R1*3
...
Horn_II_mvmt_I_BP = \transpose c' f \relative c'' {
	\mark #36
	\time 4/4
	des8 r8 r4 r2
	R1*3
...
Horn_III_mvmt_I_BP = \transpose c' f \relative c' {
	\mark #36
	\time 4/4
	cis8 r8 r4 r2
	R1*3
...
Horn_IV_mvmt_I_BP = \transpose c' f \relative c' {
	\mark #36
	\time 4/4
	fis8 r8 r4 r2
	R1*3
...
Horn_V_mvmt_I_BP = \transpose c' f \relative c''' {
	\mark #36
	\time 4/4
	\tag #'Score R1
	\tag #'Part <<
...
Horn_VI_mvmt_I_BP = \transpose c' f \relative c''' {
	\mark #36
	\time 4/4
	\tag #'Score R1
	\tag #'Part <<
...
Horn_I_III_mvmt_I_BQ = \transpose c' f \relative c'' {
	\mark #37
	\tempo "Mosso"
	\time 2/4
	cis2~\mf
...
Horn_II_mvmt_I_BQ = \transpose c' f \relative c' {
	\mark #37
	\tempo "Mosso"
	\time 2/4
	e2~\mf
...
Horn_IV_mvmt_I_BQ = \transpose c' f \relative c'' {
	\mark #37
	\tempo "Mosso"
	\time 2/4
	gis2~\mf
...
Horn_I_mvmt_I_BR = \transpose c' f \relative c'' {
	\tempo "Calmato"
	\time 4/4
	\tag #'Score \grace s8
	gis1~\mp
...
Horn_II_mvmt_I_BR = \transpose c' f \relative c' {
	\tempo "Calmato"
	\time 4/4
	\tag #'Score \grace s8
	gis1~\mp
...
Horn_III_mvmt_I_BR = \transpose c' f \relative c'' {
	\tempo "Calmato"
	\time 4/4
	\tag #'Score \grace s8
	e1~\mp
...
Horn_IV_mvmt_I_BR = \transpose c' f \relative c' {
	\tempo "Calmato"
	\time 4/4
	\tag #'Score \grace s8
	cis1~\mp
...
Horn_IV_mvmt_I = { \NULL_I_AA \Horn_IV_mvmt_I_AB \NULL_I_AC \NULL_I_AD \NULL_I_AE \Horn_IV_mvmt_I_AF \NULL_I_AG \Horn_IV_mvmt_I_AH \NULL_I_AI \NULL_I_AJ
		...
		\Horn_IV_mvmt_I_BK \Horn_IV_mvmt_I_BL \Horn_IV_mvmt_I_BM \NULL_I_BN \Horn_IV_mvmt_I_BO \Horn_IV_mvmt_I_BP \Horn_IV_mvmt_I_BQ \Horn_IV_mvmt_I_BR }
Horn_V_mvmt_I = { \NULL_I_AA \Horn_V_mvmt_I_AB \NULL_I_AC \NULL_I_AD \NULL_I_AE \NULL_I_AF \NULL_I_AG \NULL_I_AH \NULL_I_AI \NULL_I_AJ \Horn_All_mvmt_I_AK
		...
		\NULL_I_AT \NULL_I_AU \Horn_all_cues_I_AV \Horn_V_mvmt_I_AW \Horn_V_mvmt_I_AX \NULL_I_AY \NULL_I_AZ \Horn_V_VI_mvmt_I_BA \NULL_I_BB
		\NULL_I_BC \NULL_I_BD \NULL_I_BE \NULL_I_BF \NULL_I_BG \NULL_I_BH \NULL_I_BI \NULL_I_BJ \Horn_V_mvmt_I_BK \NULL_I_BL \Horn_V_mvmt_I_BM \NULL_I_BN
		\Horn_V_VI_cues_mvmt_I_BO \Horn_V_mvmt_I_BP \NULL_I_BQ \NULL_I_BR }
Horn_VI_mvmt_I = { \NULL_I_AA \Horn_VI_mvmt_I_AB \NULL_I_AC \NULL_I_AD \NULL_I_AE \NULL_I_AF \NULL_I_AG \NULL_I_AH \NULL_I_AI \NULL_I_AJ \Horn_All_mvmt_I_AK
		...
		\Horn_VI_mvmt_I_AW \Horn_VI_mvmt_I_AX \NULL_I_AY \NULL_I_AZ \Horn_V_VI_mvmt_I_BA \NULL_I_BB \NULL_I_BC \NULL_I_BD \NULL_I_BE \NULL_I_BF
		\NULL_I_BG \NULL_I_BH \NULL_I_BI \NULL_I_BJ \Horn_VI_mvmt_I_BK \NULL_I_BL \Horn_VI_mvmt_I_BM \NULL_I_BN \Horn_V_VI_cues_mvmt_I_BO
		\Horn_VI_mvmt_I_BP \NULL_I_BQ \NULL_I_BR }
Horn_VII_mvmt_I = { \NULL_I_AA \NULL_I_AB \NULL_I_AC \NULL_I_AD \NULL_I_AE \NULL_I_AF \NULL_I_AG \NULL_I_AH \NULL_I_AI \NULL_I_AJ \Horn_All_mvmt_I_AK
		\NULL_I_AL \NULL_I_AM \NULL_I_AN \Horn_V_VI_VII_mvmt_I_AO \NULL_I_AP \NULL_I_AQ \NULL_I_AR \NULL_I_AS \NULL_I_AT \NULL_I_AU \Horn_all_cues_I_AV
		\Horn_VII_mvmt_I_AW \NULL_I_AX \NULL_I_AY \NULL_I_AZ \NULL_I_BA \NULL_I_BB \NULL_I_BC \NULL_I_BD \NULL_I_BE \NULL_I_BF \NULL_I_BG \NULL_I_BH
		\NULL_I_BI \NULL_I_BJ \NULL_I_BK \NULL_I_BL \NULL_I_BM \NULL_I_BN \NULL_I_BO \NULL_I_BP \NULL_I_BQ \NULL_I_BR }
