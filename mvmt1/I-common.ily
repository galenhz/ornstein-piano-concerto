...
% BP = mm. 309-315 (Rehersal 36)
% BQ = mm. 316-327 (Rehersal 37)
% BR = mm. 328-331
...
% Need this for divisi parts.
NULL_I_BD_nofermata = { \mark #23 \tempo "Poco più Lento" \time 3/4 R2.*4 \tempo "Più agitato e crescendo" R2.*3 \time 2/4 R2*2 \time 3/4 R2.
	\bar "||" }
