...
Clarinet_I_mvmt_I_BP = \transpose c' bes \relative c''' {
	\mark #36
	\time 4/4
	\tag #'Score R1
	\tag #'Part <<
		\new CueVoice {
			\voiceOne
			g8 r8 r4 b8(^"I Fl." bes~ bes16) a( aes b)
		}
		\new Voice {
			\voiceTwo
			R1
	...
	>>
	r2 \tag #'Score e,8(\mf \tag #'Part e8(\mf^\Solo_mark ees~ ees16) d( des e
	des2) r2
	R1
	\tempo "Meno"
	\time 8/8
	\repeat unfold 2 {
		\repeat unfold 4 { \tuplet 6/4 { g32[( a g a g a]) } } \repeat unfold 4 { \tuplet 6/4 { bes[( c bes c bes c]) } }
	}
	\time 4/8
	\repeat unfold 4 { \tuplet 6/4 { gis[( a gis a gis a]) } }
}

Clarinet_III_mvmt_I_BP = \transpose c' bes \relative c''' {
	\mark #36
	\time 4/4
	\tag #'Score R1*3
	\tag #'Part <<
		\new CueVoice {
			\voiceOne
			r2 b8(^"I Fl." bes~ bes16) a( aes b
			aes2) e8(^"I Cl." ees~ ees16) d( des e
			des2) r2
		}
		\new Voice {
			\voiceTwo
	...
	\time 8/8
	\repeat unfold 2 {
		\repeat unfold 4 { \tuplet 6/4 { g,32[( a g a g a]) } } \repeat unfold 4 { \tuplet 6/4 { bes[( c bes c bes c]) } }
	}
	\time 4/8
	\repeat unfold 4 { \tuplet 6/4 { gis[( a gis a gis a]) } }
}

Clarinet_II_IV_cues_mvmt_I_BP = \transpose c' bes \relative c''' {
	\tag #'Score \NULL_I_BP
	\tag #'Part {
		\mark #36
		\time 4/4
...
%FIXME: Ugly cut-and-paste, but no easy way to squeeze the ottava in otherwise.
BassClarinet_cues_mvmt_I_BP = \transpose c' bes, \relative c'''' {
	\tag #'Score \NULL_I_BP
	\tag #'Part {
		\mark #36
		\time 4/4
		<<
			\new CueVoice {
				\voiceOne
				r2 \ottava #1 b8(^"I Fl." bes~ bes16) a( aes b
				aes2) e8(^"I Cl." ees~ ees16) d( des e
				des2) \ottava #0 r2
			}
			\new Voice {
...
Clarinet_All_mvmt_I_BR_partial = \relative c''' {
	\tempo "Calmato"
	\time 4/4
	\tag #'Score \grace s8
	\tag #'Score R1*2
	\tag #'Part <<
		\new CueVoice {
			%\voiceOne
			a8[(^"B. Cl. (8va)" gis]~ gis16[ g fis bes] \tuplet 5/4 { f[ e ees d b } \tuplet 3/2 { bes8 a gis]) }
			a'8[( gis]~ gis16[ g fis bes] \tuplet 5/4 { f[ e ees d b } \tuplet 3/2 { bes8 a gis]) }
		}
		\new Voice {
			\voiceTwo
			\override MultiMeasureRest.staff-position = #-8
...
Clarinet_I_mvmt_I_BR = \transpose c' bes \relative c''' {
	\Clarinet_All_mvmt_I_BR_partial
	\time 3/4
	r8 gis8~\pp gis2~
	gis2.
	\bar "|."
...
Clarinet_II_mvmt_I_BR = \transpose c' bes \relative c'' {
	\Clarinet_All_mvmt_I_BR_partial
	\time 3/4
	r8 dis8~\pp dis2~
	dis2.
...
Clarinet_III_mvmt_I_BR = \transpose c' bes \relative c'' {
	\Clarinet_All_mvmt_I_BR_partial
	\time 3/4
	r8 b8~\pp b2~
	b2.
...
Clarinet_IV_mvmt_I_BR = \transpose c' bes \relative c'' {
	\Clarinet_All_mvmt_I_BR_partial
	\time 3/4
	r8 gis8~\pp gis2~
	gis2.
...
BassClarinet_mvmt_I_BR = \transpose c' bes, \relative c''' {
	\tempo "Calmato"
	\time 4/4
	\tag #'Score \grace s8
	\tag #'Score a8[(\mp \tag #'Part a8[(\mp^\Solo_mark gis]~ gis16[ g fis bes] \tuplet 5/4 { f[ e ees d b } \tuplet 3/2 { bes8 a gis]) }
	a'8[( gis]~ gis16[ g fis bes] \tuplet 5/4 { f[ e ees d b } \tuplet 3/2 { bes8 a gis]) }
	\time 3/4
	R2.*2
	\bar "|."
...
Clarinet_I_mvmt_I = { \NULL_I_AA \Clarinet_I_mvmt_I_AB \NULL_I_AC \Clarinet_I_mvmt_I_AD \Clarinet_I_mvmt_I_AE \Clarinet_I_mvmt_I_AF \Clarinet_I_II_mvmt_I_AG
		...
		\Clarinet_I_cues_mvmt_I_BO \Clarinet_I_mvmt_I_BP \NULL_I_BQ \Clarinet_I_mvmt_I_BR }
Clarinet_II_mvmt_I = { \NULL_I_AA \Clarinet_II_mvmt_I_AB \NULL_I_AC \NULL_I_AD \NULL_I_AE \Clarinet_II_mvmt_I_AF \Clarinet_I_II_mvmt_I_AG \Clarinet_II_mvmt_I_AH
		...
		\Clarinet_II_mvmt_I_BM \NULL_I_BN \NULL_I_BO \Clarinet_II_IV_cues_mvmt_I_BP \NULL_I_BQ \Clarinet_II_mvmt_I_BR }
Clarinet_III_mvmt_I = { \NULL_I_AA \Clarinet_III_mvmt_I_AB \NULL_I_AC \NULL_I_AD \Clarinet_III_IV_mvmt_I_AE \Clarinet_III_mvmt_I_AF \Clarinet_III_IV_mvmt_I_AG
		...
		\Clarinet_III_mvmt_I_BK \Clarinet_III_mvmt_I_BL \Clarinet_III_mvmt_I_BM \NULL_I_BN \NULL_I_BO \Clarinet_III_mvmt_I_BP \NULL_I_BQ
		\Clarinet_III_mvmt_I_BR }
