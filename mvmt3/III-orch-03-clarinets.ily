...
Clarinet_I_II_mvmt_III_AV_BD = \transpose c' bes \relative c' {
...
Clarinet_I_II_mvmt_III_AV = { \mark #72 \Clarinet_I_II_mvmt_III_AV_BD }

% First bar of part has repeated ais instead of b in the middle. Score is correct.

Clarinet_III_IV_mvmt_III_AV_BD = \transpose c' bes \relative c' {
	\tempo "Poco a poco animato"
	\time 5/8
...
Clarinet_III_IV_mvmt_III_AV = { \mark #72 \Clarinet_III_IV_mvmt_III_AV_BD }

BassClarinet_mvmt_III_AV_BD = \transpose c' bes, \relative c' {
	\tempo "Poco a poco animato"
	\time 5/8
...
BassClarinet_mvmt_III_AV = { \mark #72 \BassClarinet_mvmt_III_AV_BD }
...
Clarinet_I_II_mvmt_III_AY_BG = \relative c''' {
	\time 5/8
	\tag #'Score \grace s8.
	g8[\f g aes-> g g]
	bes[ aes g-> g g]
...
Clarinet_I_II_mvmt_III_AY = \relative c''' {
	\mark #75
	\Clarinet_I_II_mvmt_III_AY_BG
	\time 3/4
	f4->\fff fis-> a->
}

Clarinet_III_mvmt_III_AY_BG = \relative c'' {
	\time 5/8
	\tag #'Score \grace s8.
	\partCombineApart
	e8[\f c e-> c gis']
...
Clarinet_III_mvmt_III_AY = \transpose c' bes \relative c'' {
	\mark #75
	\Clarinet_III_mvmt_III_AY_BG
	\time 3/4
	e2-^\fff e4-^
	\partCombineAutomatic
}

Clarinet_IV_mvmt_III_AY_BG = \relative c'' {
	\time 5/8
	\tag #'Score \grace s8.
	R1*5/8
	e8[\f c e-> c gis']
...
Clarinet_I_II_mvmt_III_BD = { \mark #80 \Clarinet_I_II_mvmt_III_AV_BD }

Clarinet_III_IV_mvmt_III_BD = { \mark #80 \Clarinet_III_IV_mvmt_III_AV_BD }

BassClarinet_mvmt_III_BD = { \mark #80 \BassClarinet_mvmt_III_AV_BD }
...
Clarinet_all_mvmt_III_BF = \transpose c' bes \relative c''' {
	\mark #82
	gis8->[\f gis a gis-> gis]
	b->[ a gis gis-> gis]
	gis->[ gis a gis-> gis]
	...
	a->[ fis fis f-> gis]
	a->[ b c d-> dis]
	dis->[ dis fis_\markup { \italic "cresc." } dis-> d]
	c->[ a c d-> dis]
	\time 3/8
	c->[ b-> gis->]
}

BassClarinet_mvmt_III_BF = \transpose c' c, \Clarinet_all_mvmt_III_BF

%%% Section BG = mm. 250-264 (Rehearsal 83)
% Partial copy of AY without the last measure

Clarinet_I_II_mvmt_III_BG = \transpose c' bes { \mark #83 \Clarinet_I_II_mvmt_III_AY_BG }

Clarinet_III_mvmt_III_BG = \transpose c' bes { \mark #83 \Clarinet_III_mvmt_III_AY_BG \partCombineAutomatic }

Clarinet_IV_mvmt_III_BG = \transpose c' bes { \mark #83 \Clarinet_IV_mvmt_III_AY_BG }

BassClarinet_mvmt_III_BG = \transpose c' bes, \relative c'' {
	\mark #83
	\time 5/8
	\tag #'Score \grace s8.
	r8 e4.\f e8
...
Clarinet_I_II_mvmt_III_BH = \transpose c' bes \relative c'' {
	\mark #84
	\time 9/8
	\tag #'Score \grace s8. f4->\fff f8-> f4-> f8-> f4-> f8->
	\time 5/8
	f4-> f8->[ f-> f->]
	\time 9/8
	\tag #'Score \grace s8 f4-> f8-> f4-> f8-> f4-> f8->
	\time 5/8
	f4-> f8->[ f-> f->]
	\time 6/8
	\tag #'Score \grace s8. f4-> f8-> f4-> f8->
	\time 5/8
	\tag #'Score \grace s8 f4-> f8->[ f-> f->]
	\time 6/8
	f4-> f8-> f4-> f8->
	\time 5/8
	\once \override TextSpanner.bound-details.left.text = "rit."
	f4->_\startTextSpan f8->[ f-> f->]_\stopTextSpan
	f4-> f8->[ f-> f->]
}

Clarinet_III_mvmt_III_BH = \transpose f b, \Clarinet_I_II_mvmt_III_BH

BassClarinet_mvmt_III_BH = \transpose c' bes, \relative c'' {
	\mark #84
	\time 9/8
	\tag #'Score \grace s8. b8->\fff \repeat unfold 8 { b-> }
	\time 5/8
	b8->[ b->] b4-> b8->
	\time 9/8
	\tag #'Score \grace s8 \repeat unfold 9 { b8-> }
	\time 5/8
	b8->[ b->] b4-> b8->
	\time 6/8
	\tag #'Score \grace s8. \repeat unfold 6 { b8-> }
	\time 5/8
	\tag #'Score \grace s8 b8->[ b->] b4-> b8->
	\time 6/8
	\repeat unfold 6 { b8-> }
	\time 5/8
	\once \override TextSpanner.bound-details.left.text = "rit."
	b8->[_\startTextSpan b->] b4-> b8->_\stopTextSpan
	b8->[ b->] b4-> b8->
}

%%% Section BI = mm. 274-275

Clarinet_I_II_mvmt_III_BI = \transpose c' bes \relative c'' {
	\time 3/4
	R2.
	b2.
	\bar "|."
...
Clarinet_III_IV_mvmt_III_BI = \transpose c' bes \relative c' {
	\time 3/4
	R2.
	fis2.
	\bar "|."
...
BassClarinet_mvmt_III_BI = \transpose c' bes, \relative c'' {
	\time 3/4
	R2.
	b2.
	\bar "|."
...
Clarinet_I_mvmt_III = { \NULL_III_AA \Clarinet_all_cues_mvmt_III_AB \Clarinet_I_mvmt_III_AC \NULL_III_AD \NULL_III_AE \Clarinet_I_mvmt_III_AF
		...
		\Clarinet_I_mvmt_III_BC \Clarinet_I_II_mvmt_III_BD \NULL_III_BE \Clarinet_all_mvmt_III_BF \Clarinet_I_II_mvmt_III_BG
		\Clarinet_I_II_mvmt_III_BH \Clarinet_I_II_mvmt_III_BI }
Clarinet_II_mvmt_III = { \NULL_III_AA \Clarinet_all_cues_mvmt_III_AB \Clarinet_II_mvmt_III_AC \Clarinet_II_mvmt_III_AD \NULL_III_AE
		...
		\Clarinet_II_mvmt_III_BC \Clarinet_I_II_mvmt_III_BD \NULL_III_BE \Clarinet_all_mvmt_III_BF \Clarinet_I_II_mvmt_III_BG
		\Clarinet_I_II_mvmt_III_BH \Clarinet_I_II_mvmt_III_BI }
Clarinet_III_mvmt_III = { \NULL_III_AA \Clarinet_all_cues_mvmt_III_AB \Clarinet_III_mvmt_III_AC \NULL_III_AD \NULL_III_AE
		...
		\Clarinet_III_mvmt_III_BC \Clarinet_III_IV_mvmt_III_BD \NULL_III_BE \Clarinet_all_mvmt_III_BF \Clarinet_III_mvmt_III_BG
		\Clarinet_III_mvmt_III_BH \Clarinet_III_IV_mvmt_III_BI }
Clarinet_IV_mvmt_III = { \NULL_III_AA \Clarinet_all_cues_mvmt_III_AB \Clarinet_IV_mvmt_III_AC \NULL_III_AD \NULL_III_AE \Clarinet_IV_mvmt_III_AF
		...
		\Clarinet_IV_mvmt_III_BC \Clarinet_III_IV_mvmt_III_BD \NULL_III_BE \Clarinet_all_mvmt_III_BF \Clarinet_IV_mvmt_III_BG
		\NULL_III_BH \Clarinet_III_IV_mvmt_III_BI }
BassClarinet_mvmt_III = { \NULL_III_AA \BassClarinet_cues_mvmt_III_AB \BassClarinet_mvmt_III_AC \NULL_III_AD \NULL_III_AE \NULL_III_AF
		...
		\NULL_III_AZ \BassClarinet_cues_mvmt_III_BA \BassClarinet_mvmt_III_BB \NULL_III_BC \BassClarinet_mvmt_III_BD \NULL_III_BE
		\BassClarinet_mvmt_III_BF \BassClarinet_mvmt_III_BG \BassClarinet_mvmt_III_BH \BassClarinet_mvmt_III_BI }
