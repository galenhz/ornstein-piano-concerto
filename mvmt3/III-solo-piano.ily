...
solo_upper_III_AW_BE = \relative c' {
...
solo_upper_III_AW = { \mark #73 \solo_upper_III_AW_BE }
...
solo_dynamics_III_AX = {
	s1*5/8*10 s4.
}

solo_lower_III_AX = \relative c,, {
	\repeat unfold 10 {
		<d d'>8[ \change Staff = "solo_upper" \tuplet 3/2 { <cis'' d>16 fis \beamCutR bes }
			\change Staff = "solo_lower" \beamCutL <cis d> \change Staff = "solo_upper" \beamCutR <d, fis bes>
			\beamCutL cis \change Staff = "solo_lower" \beamCutR bes \beamCutL bes, bes']
	}
	\time 3/8
	<f, f'>8[ <ees ees'> <d d'>]
}
...
solo_upper_lower_III_AY = {
	\mark #75 \time 5/8 \grace s8. R1*5/8*15 \time 3/4 R2.
}

solo_dynamics_III_AY = {
	s1*5/8*15 s2.
}
...
solo_upper_III_BC = \relative c' {
	...
	\tupletUp
	\tuplet 3/2 2 {
		r4 <bes cis fis a> <cis fis a c> <bes cis fis a> <g' bes ees fis> <bes, cis fis a> <cis' fis a c> <bes, cis fis a> <g'' bes ees fis>\fermata
	}
	\tupletNeutral
}

solo_dynamics_III_BC = {
	s1*4 s1.
}

solo_lower_III_BC = \relative c,, {
	\time 4/4
	\clef bass
	\tag #'Score \grace s8.
	R1*4
	...
	\override TupletNumber.stencil = ##f
	\tuplet 3/2 2 {
		<ees ees'>4 <cis'' g'> <a, a'> <ees ees'>4 <cis'' g'> <a, a'> <ees ees'>4 <cis'' g'> <a, a'>\fermata
	}
	\revert TupletBracket.bracket-visibility
	\revert TupletNumber.stencil
}
...
solo_upper_III_BE = { \mark #81 \solo_upper_III_AW_BE }

solo_dynamics_III_BE = \solo_dynamics_III_AW
...
solo_upper_lower_III_BG = {
	\mark #83 \time 5/8 \grace s8. R1*5/8*15
}

solo_dynamics_III_BG = {
	s1*5/8*15
}
...
solo_upper_III = { \solo_upper_III_AA \solo_upper_III_AB \solo_upper_III_AC \solo_upper_III_AD \solo_upper_III_AE \solo_upper_III_AF
		...
		\solo_upper_III_BE \solo_upper_III_BF \solo_upper_lower_III_BG \NULL_III_BH \solo_upper_III_BI }
solo_dynamics_III = { \solo_dynamics_III_AA \solo_dynamics_III_AB \solo_dynamics_III_AC \solo_dynamics_III_AD \solo_dynamics_III_AE
		...
		\solo_dynamics_III_BE \solo_dynamics_III_BF \solo_dynamics_III_BG \solo_dynamics_III_BH \solo_dynamics_III_BI }
solo_lower_III = { \solo_lower_III_AA \solo_lower_III_AB \solo_lower_III_AC \solo_lower_III_AD \solo_lower_III_AE \solo_lower_III_AF
		...
		\solo_lower_III_BE \solo_lower_III_BF \solo_upper_lower_III_BG \NULL_III_BH \solo_lower_III_BI }
