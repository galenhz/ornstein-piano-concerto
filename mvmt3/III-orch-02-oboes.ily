...
Oboe_I_II_mvmt_III_AY_BG = \relative c''' {
	\time 5/8
	\tag #'Score \grace s8.
	g8[\f g aes-> g g]
	bes[ aes g-> g g]
...
Oboe_I_II_mvmt_III_AY = \relative c'' {
	\mark #75
	\Oboe_I_II_mvmt_III_AY_BG
	\time 3/4
	f4-^\fff fis-^ a-^
}

Oboe_III_mvmt_III_AY_BG = \relative c''' {
	\time 5/8
	\tag #'Score \grace s8.
	d8[\f d ees-> d d]
...
Oboe_III_mvmt_III_AY = \relative c''' {
	\mark #75
	\Oboe_III_mvmt_III_AY_BG
	\time 3/4
	d4-^\fff d-^ d-^
}

Oboe_IV_mvmt_III_AY_BG = \relative c''' {
	\time 5/8
	\tag #'Score \grace s8.
...
Oboe_IV_mvmt_III_AY = \relative c''' {
	\mark #75
	\Oboe_IV_mvmt_III_AY_BG
	\time 3/4
	cis4-^\fff cis-^ cis-^
}

EnglishHorn_mvmt_III_AY_BG = \relative c''' {
	\time 5/8
	\tag #'Score \grace s8.
	R1*5/8*8
	f8[\f f f-> f f]
	\repeat unfold 6 { f8[ f f-> f f] }
}

EnglishHorn_mvmt_III_AY = \transpose c' f \relative c''' {
	\mark #75
	\EnglishHorn_mvmt_III_AY_BG
	\time 3/4
	f4-^\fff f-^ f-^
}
...
Oboe_all_mvmt_III_BF = \relative c'' {
	\mark #82
	fis8->[\f fis g fis-> fis]
	a->[ g fis fis-> fis]
	fis->[ fis g fis-> fis]
	...
	g->[ e e ees-> fis]
	g->[ a bes c-> cis]
	cis->[ cis e_\markup { \italic "cresc." } cis-> c]
	bes->[ g bes c-> cis]
	\time 3/8
	bes->[ a-> fis->]
}

EnglishHorn_mvmt_III_BF = \transpose c' c \Oboe_all_mvmt_III_BF

%%% Section BG = mm. 250-264 (Rehearsal 83)
% Partial copy of AY without the last measure

Oboe_I_II_mvmt_III_BG = { \mark #83 \Oboe_I_II_mvmt_III_AY_BG }

Oboe_III_mvmt_III_BG = { \mark #83 \Oboe_III_mvmt_III_AY_BG }

Oboe_IV_mvmt_III_BG = { \mark #83 \Oboe_IV_mvmt_III_AY_BG }

EnglishHorn_mvmt_III_BG = \transpose c' f { \mark #83 \EnglishHorn_mvmt_III_AY_BG }

%%% Section BH = mm. 265-273 (Rehearsal 84)

Oboe_all_mvmt_III_BH = \relative c'' {
	\mark #84
	\override Beam.breakable = ##t
	\time 9/8
	\tag #'Score \grace s8. e8->[\fff e-> f-> e-> e-> fis-> f-> f-> e->
	\time 5/8
	gis-> g-> g-> fis-> f->]
	\time 9/8
	\tag #'Score \grace s8 e8->[ e-> f-> e-> e-> fis-> f-> f-> e->
	\time 5/8
	gis-> g-> g-> fis-> f->]
	\time 6/8
	\tag #'Score \grace s8. gis8->[ f-> f-> e-> e-> cis->]
	\time 5/8
	\tag #'Score \grace s8 f8->[ e-> e-> cis-> f->]
	\time 6/8
	gis8->[ f-> f-> e-> e-> cis->]
	\time 5/8
	\once \override TextSpanner.bound-details.left.text = "rit."
	f8->[_\startTextSpan e-> e-> cis-> f->]_\stopTextSpan
	f8->[ e-> e-> cis-> f->]
}

EnglishHorn_mvmt_III_BH = \transpose c' f \relative c'' {
	\mark #84
	\time 9/8
	\tag #'Score \grace s8. r8\fff e->[ e->] r e->[ e->] r e->[ e->]
	\time 5/8
	r8 e4-> e->
	\time 9/8
...
Oboe_I_II_mvmt_III_BI = \relative c'' {
	\time 3/4
	R2.
	a2.
	\bar "|."
...
Oboe_III_IV_mvmt_III_BI = \relative c' {
	\time 3/4
	R2.
	e2.
	\bar "|."
...
EnglishHorn_mvmt_III_BI = \transpose c' f \relative c' {
	\time 3/4
	R2.
	e2.
	\bar "|."
...
Oboe_I_mvmt_III = { \NULL_III_AA \Oboe_all_cues_mvmt_III_AB \Oboe_all_mvmt_III_AC \Oboe_all_mvmt_III_AD \NULL_III_AE \NULL_III_AF \NULL_III_AG
		...
		\Oboe_all_cues_mvmt_III_BA \Oboe_all_mvmt_III_BB \NULL_III_BC \NULL_III_BD \NULL_III_BE \Oboe_all_mvmt_III_BF \Oboe_I_II_mvmt_III_BG
		\Oboe_all_mvmt_III_BH \Oboe_I_II_mvmt_III_BI }
...
Oboe_III_mvmt_III = { \NULL_III_AA \Oboe_all_cues_mvmt_III_AB \Oboe_all_mvmt_III_AC \Oboe_all_mvmt_III_AD\NULL_III_AE \NULL_III_AF \NULL_III_AG
		...
		\Oboe_all_mvmt_III_BB \NULL_III_BC \NULL_III_BD \NULL_III_BE \Oboe_all_mvmt_III_BF \Oboe_III_mvmt_III_BG \Oboe_all_mvmt_III_BH
		\Oboe_III_IV_mvmt_III_BI }
Oboe_IV_mvmt_III = { \NULL_III_AA \Oboe_all_cues_mvmt_III_AB \Oboe_all_mvmt_III_AC \Oboe_all_mvmt_III_AD \NULL_III_AE \NULL_III_AF \NULL_III_AG
		...
		\Oboe_all_mvmt_III_BB \NULL_III_BC \NULL_III_BD \NULL_III_BE \Oboe_all_mvmt_III_BF \Oboe_IV_mvmt_III_BG \Oboe_all_mvmt_III_BH
		\Oboe_III_IV_mvmt_III_BI }
EnglishHorn_mvmt_III = { \NULL_III_AA \NULL_III_AB \EnglishHorn_cues_mvmt_III_AC \NULL_III_AD \NULL_III_AE \NULL_III_AF \EnglishHorn_cues_mvmt_III_AG
		...
		\NULL_III_AV \Oboe_all_cues_mvmt_III_AW \EnglishHorn_mvmt_III_AX \EnglishHorn_mvmt_III_AY \NULL_III_AZ \NULL_III_BA \NULL_III_BB
		\NULL_III_BC \NULL_III_BD \NULL_III_BE \EnglishHorn_mvmt_III_BF \EnglishHorn_mvmt_III_BG \EnglishHorn_mvmt_III_BH \EnglishHorn_mvmt_III_BI }
