...
NULL_II_AL = { \tempo "Più mosso" \time 5/4 R1*5/4 \time 6/8 R2. \mark #46 \time 5/4 R1*5/4 \time 5/8 R1*5/8 \time 5/4 R1*5/4 \time 3/4 R2. \time 5/4 R1*5/4 }
...
NULL_II_AQ = { \tempo "Meno" \set Staff.timeSignatureFraction = 4/4 R2.*4 \unset Staff.timeSignatureFraction }
NULL_II_AR = { \mark #50 \time 3/4 R2.*3 \bar "|." }
